...
const ExperienceForm = ({ data, onChange }) => {
    ...
    const generateDescription = async (index) => {
        ...
        const prompt = `Enhance this job description ${experience.description} for the the position of ${experience.position} at ${experience.company}`;
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <button onClick={()=> generateDescription(index)}
                                        ...
                                        { generatingIndex === index ? (
                                            <Loader2 className='w-3 h-2 animate-spn'/>
                                        ):(
